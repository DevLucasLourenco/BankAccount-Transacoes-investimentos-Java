...
public class AtivosDeUsuarios {
    ...
    public double __encontrarDinheiroFicticio(){
        ...
        // Criei este método em outro módulo, pois não faria sentido o usuário ter um dado tão importante armazenado dentro da class Usuário. Portando, seguindo o "D" de SOLID, eu realizei a Inversão de Dependencia
